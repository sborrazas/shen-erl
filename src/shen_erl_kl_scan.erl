-file("/usr/local/opt/asdf/installs/erlang/20.1/lib/erlang/lib/parsetools-2.1.5/include/leexinc.hrl", 0).
...
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 47 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(2, Ics, Line, Tlen+1, 3, Tlen);
yystate(9, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
yystate(9, Ics, Line, Tlen, _, _) ->
    {3,Tlen,Ics,Line,9};
yystate(8, [10|Ics], Line, Tlen, _, _) ->
    yystate(8, Ics, Line+1, Tlen+1, 5, Tlen);
...
yystate(6, [40|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [41|Ics], Line, Tlen, Action, Alen) ->
    yystate(7, Ics, Line, Tlen+1, Action, Alen);
...
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 32 ->
    yystate(8, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 35, C =< 39 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 42, C =< 44 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 48, C =< 57 ->
    yystate(2, Ics, Line, Tlen+1, Action, Alen);
yystate(6, [C|Ics], Line, Tlen, Action, Alen) when C >= 58 ->
    yystate(4, Ics, Line, Tlen+1, Action, Alen);
...
yystate(5, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(4, Ics, Line, Tlen+1, 1, Tlen);
...
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
yystate(4, [C|Ics], Line, Tlen, _, _) when C >= 42 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
...
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 35, C =< 39 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
yystate(2, [C|Ics], Line, Tlen, _, _) when C >= 42, C =< 45 ->
    yystate(4, Ics, Line, Tlen+1, 0, Tlen);
...
yystate(1, [C|Ics], Line, Tlen, _, _) when C >= 58 ->
    yystate(4, Ics, Line, Tlen+1, 3, Tlen);
...
-file("/usr/local/opt/asdf/installs/erlang/20.1/lib/erlang/lib/parsetools-2.1.5/include/leexinc.hrl", 309).
